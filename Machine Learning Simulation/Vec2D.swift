...
public class Vec2D: CustomStringConvertible{
    ...
    public class func angleBetween(_ vec1: Vec2D, _ vec2: Vec2D) -> CGFloat {
        if vec1.x == 0.0 && vec1.y == 0.0 {return 0.0}
        else if vec2.x == 0.0 && vec2.y == 0.0 {return 0.0}
        else {
    ...
    public class func random() -> Vec2D {
        let seed1 = CGFloat(arc4random_uniform(100000)) - 50000
        let seed2 = CGFloat(arc4random_uniform(100000)) - 50000
